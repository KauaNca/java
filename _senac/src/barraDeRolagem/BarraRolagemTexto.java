...
*/
public class BarraRolagemTexto extends JFrame {
    JTextArea quadrado;
    JScrollPane barraTexto;
    
    public BarraRolagemTexto(){
    ...
    public void textArea(){
        ...
        barraTexto = new JScrollPane(quadrado);
    }
    ...
    public static void main(String[] args){
        new BarraRolagemTexto(); // Cria o frame e inicializa tudo no construtor
    }
}
