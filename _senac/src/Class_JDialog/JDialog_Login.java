 ...
 * @author kauan
 */
public class JDialog_Login extends javax.swing.JFrame {
    ...
    public JDialog_Login() {
        initComponents();
        JDialog_Login2 lj = new JDialog_Login2(this,true);
        lj.setVisible(true);
        label.setText("Bem-vindo " + lj.usuario);//UTILIZANDO VARIÁVEL DE OUTRA TELA
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JDialog_Login().setVisible(true);
            }
        });
    }
