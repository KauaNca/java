...
public class Teclado extends javax.swing.JFrame {
    ...
    private void formKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyReleased
        char letra = evt.getKeyChar(); //utilizando o evt é possível pegar o que é digitado do teclado
        System.out.println(letra);
    }//GEN-LAST:event_formKeyReleased

    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
        int codigo = evt.getKeyCode(); //esse é para saber qual número representa aquela tecla
